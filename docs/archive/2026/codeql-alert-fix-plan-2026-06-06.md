# CodeQL alerts fix plan — historical snapshot

> [!IMPORTANT]
> This document records a June 6, 2026 alert inventory and remediation plan.
> It is retained as engineering history and does not describe the live CodeQL
> alert state. Query GitHub and inspect the current source before making any
> present-tense security claim.
