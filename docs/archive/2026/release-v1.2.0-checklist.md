# Release v1.2.0 — historical checklist

> [!IMPORTANT]
> This is the one-off checklist retained from the v1.2.0 release work. It is
> historical evidence, not the current release process. Commands, branches,
> versions, test counts, and workflow behaviour below reflect that snapshot.
