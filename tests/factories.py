...
class FileFactory:
    ...
    @staticmethod
    def create_text_file(directory: Path, name: str = "test.txt", content: str = "test content") -> Path:
    ...
    @staticmethod
    def create_binary_file(directory: Path, name: str = "test.bin", size: int = 1024) -> Path:
    ...
    @staticmethod
    def create_large_file(directory: Path, name: str = "large.txt", mb_size: int = 1) -> Path:
...
class VaultFactory:
    ...
    @staticmethod
    def create_vault_entry(key: Optional[str] = None, value: Optional[str] = None) -> tuple[str, str]:
...
class ErrorFactory:
    ...
    @staticmethod
    def create_file_not_found_error(path: str = "/test/missing.txt") -> FileNotFoundError:
